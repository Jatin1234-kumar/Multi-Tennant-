...
const { createProjectSchema, listProjectsSchema, deleteProjectSchema } = require('../models/schemas/project.schema');
...
router.delete('/:projectId', allowRoles('Admin'), validate(deleteProjectSchema), projectController.deleteProject);
